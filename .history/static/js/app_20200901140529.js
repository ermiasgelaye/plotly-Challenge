            ...
            var data = [
                {
                    ...
                    gauge: {
                        ...
                        steps: [
                            { range: [0, 1], color: '#bfd6f6' },
                            { range: [1, 2], color: '#84c1ff' #84c1ff},
                            { range: [2, 3], color: '#8dbdff' },
                            { range: [3, 4], color: '#64a1f4'},
                            { range: [4, 5], color: '#b3cde0' },
                            { range: [5, 6], color: '#6497b1' },
                            { range: [6, 7], color: '#005b96' },
                            { range: [7, 8], color: '#03396c' },
                            { range: [8, 9], color: '#011f4b' }
                        ],
                    },
                },
            ];
