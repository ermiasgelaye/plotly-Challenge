            ...
            var data = [
                {
                    ...
                    gauge: {
                        ...
                        steps: [
                            { range: [0, 1], color: '#7cb6ff' },
                            { range: [1, 2], color: '3890ff' },
                            { range: [2, 3], color: '#003f8d' },
                            { range: [3, 4], color: '#64a1f4'},
                            { range: [4, 5], color: '#00377c' },
                            { range: [5, 6], color: '#00306b' },
                            { range: [6, 7], color: '#002149' },
                            { range: [7, 8], color: '#001938' },
                            { range: [8, 9], color: '#001127' }
                        ],
                    },
                },
            ];
